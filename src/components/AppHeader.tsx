          ...
          <div className="relative flex items-center" ref={scanMenuRef}>
            ...
            {isScanMenuOpen && !loading && (
              <div className={cn(
                ...
                {data && (
                    <button
                      onClick={() => { handleRefresh(); setIsScanMenuOpen(false); }}
                      className="w-full text-left px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 flex items-center gap-3 transition-colors"
                    >
                      <div className="w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400">
                        <RefreshCw size={18} />
                      ...
                      <div>
                        <div className="text-sm font-medium text-gray-900 dark:text-gray-100">{t('rescanCurrent')}</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">{t('rescanCurrent')}</div>
                      </div>
                    </button>
                  )}
                ...
                {(physicalDisks.length > 0 || availableDisks.length > 0) && (
                  <>
                    ...
                    <div className="px-3 py-2 flex items-center justify-between">
                      ...
                      <button 
                        onClick={loading ? undefined : refreshDrives} 
                        disabled={loading}
